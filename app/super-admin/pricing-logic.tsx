...
const styles = StyleSheet.create({
  ...
  ruleName: { fontSize: 13, fontFamily: "Inter_700Bold", flex: 1 },
  ...
  rulePriceLabel: { fontSize: 9, fontFamily: "Inter_600SemiBold" },
  rulePriceValue: { fontSize: 14, fontFamily: "Inter_700Bold" },
  ...
  fieldLabel: { fontSize: 11, fontFamily: "Inter_700Bold", letterSpacing: 0.5, marginTop: 8, marginBottom: 4 },
  fieldInput: {
    borderWidth: 1,
    borderRadius: 10,
