...
const styles = StyleSheet.create({
  ...
  currentBadgeText: { fontSize: 8, fontFamily: "Inter_700Bold", color: "#fff" },
  planEditIcon: { position: "absolute", top: 8, right: 8 },
  planName: { fontSize: 12, fontFamily: "Inter_700Bold", marginTop: 16 },
  ...
  invoiceLabel: { fontSize: 13, fontFamily: "Inter_500Medium", flex: 1 },
  ...
  fieldLabel: { fontSize: 11, fontFamily: "Inter_700Bold", letterSpacing: 0.5, marginTop: 4 },
  fieldInput: {
    borderWidth: 1,
    borderRadius: 10,
    paddingHorizontal: 14,
