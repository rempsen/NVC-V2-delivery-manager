...
const styles = StyleSheet.create({
  ...
  periodText: { fontSize: 12, fontFamily: "Inter_700Bold" },
  ...
  metricSub: { fontSize: 10, fontFamily: "Inter_600SemiBold" },
  ...
  topClientRankText: { fontSize: 12, fontFamily: "Inter_700Bold" },
  topClientNameRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 4 },
  topClientName: { fontSize: 13, fontFamily: "Inter_600SemiBold", flex: 1 },
  topClientMrr: { fontSize: 13, fontFamily: "Inter_700Bold" },
