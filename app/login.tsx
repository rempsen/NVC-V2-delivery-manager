            ...
            {forgotSent ? (
              <View style={styles.modalSentWrap}>
                ...
                <Text style={styles.modalBody}>
                  If an account exists for <Text style={{ fontFamily: "Inter_700Bold" }}>{forgotEmail}</Text>, a password reset link has been sent.
                </Text>
...
const styles = StyleSheet.create<{
  ...
  scroll: { flexGrow: 1, paddingHorizontal: 22, paddingTop: 36, paddingBottom: 44 },
  brandSection: { alignItems: "center", marginBottom: 32 },
  logoWrap: { width: 80, height: 80, borderRadius: 24, backgroundColor: "#fff", alignItems: "center", justifyContent: "center", marginBottom: 14, shadowColor: NVC_BLUE, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.14, shadowRadius: 14, elevation: 6 },
  logoImg: { width: 56, height: 56 },
  brandTitle: { fontSize: 28, fontFamily: "Inter_700Bold", color: "#0F172A", letterSpacing: -0.6 },
  brandSubtitle: { fontSize: 13, fontFamily: "Inter_400Regular", color: "#64748B", marginTop: 4 },
  card: { backgroundColor: "#fff", borderRadius: 20, padding: 24, shadowColor: "#0F172A", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.07, shadowRadius: 20, elevation: 5, marginBottom: 16, borderWidth: 1, borderColor: "#F1F5F9" },
  socialSection: { gap: 10, marginBottom: 20 },
  socialBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", height: 50, borderRadius: 12, gap: 10 },
  googleBtn: { backgroundColor: "#F8FAFC", borderWidth: 1.5, borderColor: "#E2E8F0" },
  googleIcon: { width: 20, height: 20, borderRadius: 10, backgroundColor: "#fff", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#E2E8F0" },
  googleIconText: { fontSize: 12, fontFamily: "Inter_700Bold", color: "#4285F4" },
  googleBtnText: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: "#374151" },
  appleBtn: { height: 50, borderRadius: 12 },
  appleWebBtn: { backgroundColor: "#0F172A" },
  appleBtnText: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: "#fff" },
  divider: { flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 20 },
  dividerLine: { flex: 1, height: 1, backgroundColor: "#E2E8F0" },
  dividerText: { fontSize: 12, fontFamily: "Inter_500Medium", color: "#94A3B8" },
  form: { gap: 12 },
  inputWrapper: { flexDirection: "row", alignItems: "center", backgroundColor: "#F8FAFC", borderRadius: 12, borderWidth: 1.5, borderColor: "#E2E8F0", paddingHorizontal: 14, height: 52, gap: 10 },
  input: { flex: 1, fontSize: 15, fontFamily: "Inter_400Regular", color: "#0F172A" },
  forgotBtn: { alignSelf: "flex-end", paddingVertical: 3 },
  ...
  footerVersion: { fontSize: 11, fontFamily: "Inter_400Regular", color: "#C4C9D4" },
  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.45)", justifyContent: "center", alignItems: "center", padding: 24 },
  modalCard: { backgroundColor: "#fff", borderRadius: 24, padding: 24, width: "100%", maxWidth: 400, shadowColor: "#000", shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.14, shadowRadius: 28, elevation: 10 },
  modalTitle: { fontSize: 20, fontFamily: "Inter_700Bold", color: "#0F172A", marginBottom: 6 },
  modalBody: { fontSize: 14, fontFamily: "Inter_400Regular", color: "#64748B", lineHeight: 21 },
  modalSentWrap: { alignItems: "center", gap: 12 },
  modalSentIcon: { marginBottom: 4 },
  modalDoneBtn: { backgroundColor: "#22C55E", height: 50, borderRadius: 12, alignItems: "center", justifyContent: "center", marginTop: 16, width: "100%" },
  modalDoneBtnText: { color: "#fff", fontSize: 16, fontFamily: "Inter_700Bold" },
});
