...
const styles = StyleSheet.create({
  ...
  statusBanner: { flexDirection: "row", alignItems: "center", margin: 16, marginBottom: 8, padding: 14, borderRadius: 14, borderWidth: 1.5, gap: 8 },
  statusDot: { width: 10, height: 10, borderRadius: 5 },
  statusText: { fontSize: 14, fontFamily: "Inter_700Bold", flex: 1 },
  ...
  priorityText: { fontSize: 10, fontFamily: "Inter_700Bold", letterSpacing: 0.6 },
  card: { margin: 16, marginTop: 8, borderRadius: 16, borderWidth: 1, borderColor: "#F1F5F9", padding: 16, gap: 10, shadowColor: "#0F172A", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 10, elevation: 2 },
  ...
  advanceBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", paddingVertical: 14, borderRadius: 12, gap: 6, marginTop: 4, minHeight: 48, shadowColor: "#1E3A5F", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4 },
  advanceBtnText: { color: "#fff", fontFamily: "Inter_700Bold", fontSize: 15 },
  navigateCard: { flexDirection: "row", alignItems: "center", margin: 16, marginTop: 8, borderRadius: 16, borderWidth: 1, borderColor: "#F1F5F9", padding: 14, gap: 12, shadowColor: "#0F172A", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 },
  navigateIconWrap: { width: 44, height: 44, borderRadius: 22, backgroundColor: "#EEF2FF", alignItems: "center", justifyContent: "center" },
  navigateLabel: { fontSize: 11, fontFamily: "Inter_500Medium", marginBottom: 2 },
  navigateAddress: { fontSize: 14, fontFamily: "Inter_600SemiBold", lineHeight: 19 },
  ...
  contactBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingVertical: 12, borderRadius: 10, gap: 6, minHeight: 44 },
  contactBtnText: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  techRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  techAvatar: { width: 48, height: 48, borderRadius: 24, alignItems: "center", justifyContent: "center" },
  techInitial: { fontSize: 18, fontFamily: "Inter_700Bold" },
  techInfo: { flex: 1 },
  techName: { fontSize: 15, fontFamily: "Inter_700Bold" },
  techSkills: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 2 },
  reassignBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, paddingVertical: 10 },
  reassignText: { fontSize: 12, fontFamily: "Inter_500Medium" },
  unassignedRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  unassignedText: { fontSize: 14, fontFamily: "Inter_500Medium" },
  assignBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", paddingVertical: 14, borderRadius: 12, gap: 6, marginTop: 4, minHeight: 48, shadowColor: "#1E3A5F", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4 },
  assignBtnText: { color: "#fff", fontFamily: "Inter_600SemiBold", fontSize: 14 },
  actionsRow: { flexDirection: "row", gap: 10, marginHorizontal: 16, marginTop: 8 },
  actionBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingVertical: 14, borderRadius: 12, gap: 6, minHeight: 50 },
  ...
  noTechText: { textAlign: "center", paddingVertical: 20, fontSize: 14, fontFamily: "Inter_400Regular" },
  ...
  techOptionName: { flex: 1, fontSize: 15, fontFamily: "Inter_600SemiBold" },
