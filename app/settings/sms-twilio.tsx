...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontWeight: "700", color: "#fff" } as TextStyle,
  ...
  statusText: { fontSize: 11, fontWeight: "700", color: "#fff" } as TextStyle,
  scroll: { flex: 1 },
  ...
  cardTitle: { fontSize: 15, fontWeight: "700", color: "#111827" } as TextStyle,
  ...
  fieldLabel: { fontSize: 13, fontWeight: "600", color: "#374151" } as TextStyle,
  ...
  testBtnText: { color: "#fff", fontSize: 13, fontWeight: "700" } as TextStyle,
  saveBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8,
    backgroundColor: NVC_BLUE, borderRadius: 14,
    paddingVertical: 14, marginTop: 4,
  } as ViewStyle,
  saveBtnText: { color: "#fff", fontSize: 16, fontWeight: "700" } as TextStyle,
});
