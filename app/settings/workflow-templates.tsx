...
const styles = StyleSheet.create({
  ...
  industryTabText: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  ...
  sectionTitle: { fontSize: 11, fontFamily: "Inter_700Bold", letterSpacing: 0.5, marginBottom: 6 },
  ...
  templateName: { fontSize: 15, fontFamily: "Inter_700Bold" },
  customBadge: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 8 },
  customBadgeText: { fontSize: 10, fontFamily: "Inter_700Bold" },
  templateIndustry: { fontSize: 12, fontFamily: "Inter_600SemiBold", marginBottom: 2 },
  ...
  templateActionText: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  ...
  fieldRowIndex: { fontSize: 11, fontFamily: "Inter_700Bold" },
  fieldRowIcon: { width: 32, height: 32, borderRadius: 8, alignItems: "center", justifyContent: "center" },
  fieldRowLabel: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  ...
  addFieldBtnText: { fontSize: 14, fontFamily: "Inter_700Bold" },
  ...
  fieldPickerTitle: { fontSize: 15, fontFamily: "Inter_700Bold" },
  ...
  fieldTypeLabel: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  ...
  previewLinkText: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  ...
  fieldLabel: { fontSize: 11, fontFamily: "Inter_700Bold", letterSpacing: 0.4, marginBottom: 5, marginTop: 10 },
  ...
  ratingOptionText: { fontSize: 13, fontFamily: "Inter_700Bold" },
  ...
  addOptionText: { fontSize: 13, fontFamily: "Inter_700Bold" },
  ...
  conditionalFieldText: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
  ...
  operatorBtnText: { fontSize: 13, fontFamily: "Inter_700Bold" },
  // Preview Screen
  ...
  previewHeaderTitle: { fontSize: 16, fontFamily: "Inter_700Bold", color: "#1E293B" },
  ...
  previewBannerText: { fontSize: 11, fontFamily: "Inter_700Bold", color: "#92400E", letterSpacing: 0.3 },
  ...
  previewFieldLabel: { fontSize: 14, fontFamily: "Inter_700Bold", flex: 1 },
  ...
  previewCurrencySymbol: { fontSize: 16, fontFamily: "Inter_700Bold", marginRight: 6 },
  ...
  previewToggleLabel: { fontSize: 14, fontFamily: "Inter_700Bold" },
  ...
  previewPhotoBtnText: { fontSize: 13, fontFamily: "Inter_700Bold" },
  ...
  previewGpsBtnText: { fontSize: 14, fontFamily: "Inter_700Bold" },
  ...
  previewFormulaText: { fontSize: 13, fontFamily: "Inter_600SemiBold", flex: 1 },
  ...
  previewSubmitText: { color: "#fff", fontSize: 16, fontFamily: "Inter_700Bold" },
});
