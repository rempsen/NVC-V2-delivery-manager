...
const styles = StyleSheet.create({
  ...
  previewBrandName: { fontSize: 16, fontFamily: "Inter_700Bold", color: "#fff" },
  previewTag: { fontSize: 11, fontFamily: "Inter_700Bold", color: "rgba(255,255,255,0.7)", letterSpacing: 0.5 },
  ...
  colorSectionLabel: { fontSize: 11, fontFamily: "Inter_700Bold", letterSpacing: 0.5, marginTop: 4, marginBottom: 8 },
