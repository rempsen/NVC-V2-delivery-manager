...
const styles = StyleSheet.create({
  ...
  nvcBadgeText: { color: "#fff", fontFamily: "Inter_700Bold", fontSize: 13 },
  tabBar: {
    flexDirection: "row",
    borderBottomWidth: 1,
  },
  ...
  sectionTitle: { fontSize: 18, fontFamily: "Inter_700Bold", marginBottom: 16, color: "#11181C" },
  statsGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 12,
  ...
  statValue: { fontSize: 28, fontFamily: "Inter_700Bold", color: "#11181C" },
  ...
  chipText: { fontSize: 12, color: "#374151", fontFamily: "Inter_500Medium" },
  ...
  merchantName: { fontSize: 16, fontFamily: "Inter_700Bold", color: "#11181C", flex: 1 },
  ...
  actionBtnTextPrimary: { color: "#fff", fontSize: 12, fontFamily: "Inter_600SemiBold" },
  actionBtnTextSecondary: { color: "#374151", fontSize: 12, fontFamily: "Inter_600SemiBold" },
  actionBtnTextDanger: { color: "#EF4444", fontSize: 12, fontFamily: "Inter_600SemiBold" },
  actionBtnTextSuccess: { color: "#22C55E", fontSize: 12, fontFamily: "Inter_600SemiBold" },
  badge: {
    paddingHorizontal: 8,
    paddingVertical: 3,
    borderRadius: 6,
  ...
  pageBtnText: { color: "#fff", fontFamily: "Inter_600SemiBold", fontSize: 13 },
  ...
  userInfo: { flex: 1 },
  userName: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: "#11181C" },
  userEmail: { fontSize: 13, color: "#687076", marginTop: 2 },
  userMeta: { alignItems: "flex-end", gap: 4 },
  roleBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  roleBadgeText: { color: "#fff", fontSize: 11, fontFamily: "Inter_700Bold" },
  ...
  taskCustomer: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: "#11181C" },
  ...
  fieldLabel: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#374151", marginBottom: 6, marginTop: 12 },
  input: {
